...
GitHub tiene un programa llamado [Student Developer Pack](https://education.github.com/pack) que básicamente te da acceso gratuito a un montón de herramientas de desarrollo mientras seas estudiante verificado. Entre ellas está GitHub Copilot, que normalmente cuesta 10 dólares al mes. El acceso es completo, no una versión recortada.

Lo que más me sorprendió es que no es un trial de 30 días ni nada parecido. Mientras mantengas el estado de estudiante verificado, lo tienes activo. Para alguien que está aprendiendo a programar y no tiene ingresos propios, eso marca una diferencia enorme.
...
Una vez que te aprueban el pack, el paso que mucha gente no sabe es que tienes que ir manualmente a la configuración de tu cuenta en GitHub, entrar en el apartado de Copilot, y activarlo desde ahí. No se activa solo. Cuando lo haces, te dice claramente que tienes acceso gratuito por el Student Pack y no te pide ningún método de pago.
